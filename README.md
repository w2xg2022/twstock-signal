...
- **regime 濾網（操作層）**：進場當下，個股所屬市場的指數必須**站上季線（MA60）**才進場；跌破則該檔標記「轉弱」、建議空手（持現金）。全量 131 個月回測（116 期、扣成本）顯示：逐市場 MA60 濾網把**夏普 0.81→1.04、最大回撤 44%→32%**，且報酬不減反增、樣本內外兩半皆成立（是真的擇時、非等比降風險）。頁面「對戰總表」同時並列「我們」與「我們﹢季線濾網」兩版績效。
